  ...
  return (
    <div>
     <div class="container9">
          <span class="text">Network Graph</span>
     </div>
     <hr></hr>
    <div style={{ width: '30rem',height: '17rem',marginLeft: '12rem',marginRight:"1rem",marginTop:"0.6rem" }}>
      <iframe title="ITONICS Cloud"  xml="lang" src="https://hub.graphistry.com/graph/graph.html?dataset=bc2d4b1df95e4c18a3c7c148d397cbc1" width="250%" height="500" name="iFrame" data-service="teaser.itonics"></iframe>
